...
% Building “negative” IRFs (to show -0.05 for y* and -0.03 for pref. shock)
...
figure('Name','Negative Shock eta_z (-0.03)','NumberTitle','off');
...
figure('Name','Negative Shock eta_y*  (-0.05)','NumberTitle','off');
...
figure('Name','Combined: eta_y* =-0.05, eta_z=-0.03','NumberTitle','off');
